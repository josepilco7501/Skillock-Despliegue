...
public class Wallet : BaseEntity
{
    ...
    /// <summary>
    /// Acredita la comisión de plataforma directamente a SaldoDisponible.
    /// Solo usar para la wallet de la plataforma en la liquidación.
    /// </summary>
    public void AcreditarPlatformFee(decimal monto)
    {
        if (monto <= 0) throw new DomainException("El monto del fee debe ser positivo.");
        SaldoDisponible += monto;
        UpdatedAt = DateTime.UtcNow;
    }
