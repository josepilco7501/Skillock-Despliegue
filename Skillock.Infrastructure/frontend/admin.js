...
async function apiCall(endpoint, options = {}) {
    const headers = {
        ...
        const scrollToAdminRegisterFormBtn = document.getElementById('scrollToAdminRegisterFormBtn');
        if (scrollToAdminRegisterFormBtn) {
            scrollToAdminRegisterFormBtn.addEventListener('click', () => {
                switchAdminView('admin-register');
            });
        }
